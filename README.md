...
On first run, Hive applies all DB migrations and registers a default maestro named `dev`. You should see `Telegram bridge started, polling for updates` in the logs.
