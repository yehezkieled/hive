...
- [ ] The approved design is exported and stored in `docs/design/`.
...
## Notes
Migrated from `docs/archive/tickets/053-tabbed-work-view/`. Lavish design ticket, driven by /pm:work; the tdd gate is the browser review. Non-goals: the home (T002), steering a live Workflow run (ADR 0014), per-entity controls beyond clear/reset.
